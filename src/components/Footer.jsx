              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-4">
                  <div className="flex items-center bg-green-500/10 border border-green-500/20 rounded-full px-3 py-1">
                    ...
                    <span className="text-xs text-green-400 font-medium">Licensed Term</span>
                  </div>
                  <div className="flex items-center bg-blue-500/10 border border-blue-500/20 rounded-full px-3 py-1">
                    ...
                    <span className="text-xs text-blue-400 font-medium">Verified dhflkasjdflsakdjf sdfasdfkasjhdfjkas dfjasdgfhkajsdhfas dfausdhfkasjdhf sdfjhgasdkfjhasldgit </span>
                  </div>
                </div>
              </div>
            </div>
