          ...
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center space-x-4">
              ...
              <div className="relative group">
                ...
                <input
                  type="text"
                  placeholder="Search members, claims..."
                  className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 hover:shadow-md focus:shadow-lg"
                />
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <TooltipWrapper tooltip="Notifications">
                <button className="p-2 text-gray-600 hover:bg-gray-100 rounded-lg transition-all duration-200 hover:scale-110 relative">
              ...
              <div className="flex items-center space-x-3 group cursor-pointer">
                ...
                <div className="w-10 h-10 bg-gradient-to-br from-blue-600 to-blue-700 rounded-full flex items-center justify-center shadow-md group-hover:shadow-lg transition-all duration-200 group-hover:scale-110">
                ...
                <TooltipWrapper tooltip="Logout">
                  <button
                    onClick={logout}
                    className="p-2 text-gray-600 hover:bg-red-50 hover:text-red-600 rounded-lg transition-all duration-200 hover:scale-110"
                  >
