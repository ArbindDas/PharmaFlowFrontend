...
//   const LoadingScreen = () => (
//     <div className={`fixed inset-0 bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-600 flex items-center justify-center z-50 transition-all duration-700 ${showLoader ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}>
...
//       <div className={`bg-white rounded-3xl p-10 max-w-lg mx-4 transform transition-all duration-700 ${showWelcomePopup ? 'scale-100 translate-y-0 rotate-0' : 'scale-75 translate-y-8 rotate-3'}`}>
//         <button 
...
//                 }}
//                 className="flex-1 border-2 border-indigo-600 text-indigo-600 py-3 px-6 rounded-full font-semibold hover:bg-indigo-600 hover:text-white transition-all duration-300 transform hover:scale-105"
//               >
//                 Get Help
//               </button>
//             </div>
...
//       <div className={`bg-white rounded-2xl p-8 max-w-lg mx-4 transform transition-all duration-300 ${showConsultationPopup ? 'scale-100 translate-y-0' : 'scale-95 translate-y-4'}`}>
//         <button 
...
//           <p className="text-gray-600 mb-6">Connect with our licensed pharmacists for personalized health advice.</p>
...
//           <div className="absolute inset-0 bg-gradient-to-r from-indigo-100 to-purple-100 opacity-30 rounded-3xl transform -rotate-1"></div>
...
//               <span className="text-indigo-600 font-semibold"> Experience healthcare reimagined.</span>
//             </p>
...
//               <button 
//                 onClick={() => setShowConsultationPopup(true)}
//                 className="border-2 border-indigo-600 text-indigo-600 px-8 py-4 rounded-full text-lg font-semibold hover:bg-indigo-600 hover:text-white transition-all duration-300 transform hover:scale-105"
//               >
//                 Free Consultation
//               </button>
//             </div>
...
//               <stat.icon className="text-indigo-600 mx-auto mb-3" size={32} />
...
//             }
//           ].map((feature, index) => (
//             <div key={index} className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-3 hover:scale-105">
...
//               <div className="flex items-center text-indigo-600 mt-4 group-hover:translate-x-2 transition-transform duration-300">
...
//         <div className={`my-16 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-3xl p-8 transition-all duration-1000 delay-900 ${pageLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
...
//             ].map((item, index) => (
//               <div key={index} className="flex flex-col items-center p-6 bg-white rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
//                 <item.icon className="text-indigo-600 mb-3" size={32} />
