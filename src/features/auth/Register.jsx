...
//   //   } else {
//   //     // Additional check for TLD length (2-6 characters is standard)
//   //     const parts = value.split('.');
//   //     const tld = parts[parts.length - 1];
      
//   //     if (tld.length < 2 || tld.length > 6) {
//   //       return 'The last part of the email should be 2-6 characters.';
//   //     }
...
//     // Check for valid TLD length (2-6 characters for most TLDs)
//     if (tld.length < 2 || tld.length > 6) {
